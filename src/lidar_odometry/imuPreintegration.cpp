...
public:
    ...
    {   
        ...
        subOdometry = nh.subscribe<nav_msgs::Odometry>(PROJECT_NAME + "/mapping/odometry_incremental", 5,    &IMUPreintegration::odometryHandler, this, ros::TransportHints().tcpNoDelay());
